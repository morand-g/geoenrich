const translations = {
  en: {
    ...
    fileTooLarge: "The file is too large! Maximum allowed size is 100 MB.",
  ...
  fr: {
    ...
    preview: "Aperçu",
    fileTooLarge: "Le fichier est trop volumineux. La taille maximale autorisée est de 100 Mo.",
  ...
  fileTooLarge: "الملف كبير جداً! الحد الأقصى المسموح به هو100 ميغابايت.",
...
zh: {
  ...
  preview: "预览",
  summaryStats: "摘要统计",
  fileTooLarge: "文件太大！允许的最大大小为 100 MB。",
